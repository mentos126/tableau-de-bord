...
import { brawlstarsServices } from '../../services/brawlstars.service'
...
export interface Actions {
  [BrawlstarsActionTypes.GET_BRAWLSTARS_PROFILE]({}: AugmentedActionContext, profileId: string): unknown
}
